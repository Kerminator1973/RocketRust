...
Что ещё понравилось в конкретной задаче - оптимизация некоторых математических операций по эверистическим формулам. Это даже на практике можно применить в каких-то проектах.
