...
- Cloudflare заменил ключевые системы, требующие высокой производительности, на Rust (26 сентября 2025 г). Однако через 53 дня (18 ноября 2025 г) у Cloudflare происходит масштабный сбой, который вывел из строя значительные части Интернета, из-за ошибки... в том самом Rust-коде
