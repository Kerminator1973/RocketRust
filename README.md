...
>Ноябрь 2025 года: реализация coreutils на Rust оказалась полным провалом. Продукт не зрелый, содержит множество уязвимостей и Canonical продлила LTS (версия Ubuntu без coreutils на Rust) на 10 лет.
>
